...
<div class="col w-75">
  <div class="d-flex justify-content-end help">
    <div class="col">
    <div class="card bg-dark text-white w-75">
            <img src="../assets/images/pictures/community-manager.jpg" class="card-img" alt="...">
            <div class="card-img-overlay d-flex flex-column bd-highlight justify-content-start">
  ...
  <div class="d-flex justify-content-start help">
    <div class="col">
    <div class="card bg-dark text-white w-75">
            <img src="../assets/images/pictures/community-manager.jpg" class="card-img" alt="...">
            <div class="card-img-overlay d-flex flex-column bd-highlight justify-content-start">
